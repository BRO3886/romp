...
- History grows without a retention policy in v0. The table records only what the taxonomy names, so a future report ("what got done last week") has the raw material.
